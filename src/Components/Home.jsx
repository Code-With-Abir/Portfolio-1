...
import myPic from "../Image/Main.jpg";
      ...
      <section id="Home" className="bg-black">
        <div className="container w-10/12 mx-auto grid grid-cols-1 md:grid-cols-2 py-5  items-center justify-between pb-10">
          ...
          >
            ...
            >
              <input
                className="bg-black mt-6 text-red-500 font-bold w-[100%] "
                type="text"
              />
            </ReactTyped>
            <p className="mt-5">
            ...
            <div className="flex gap-4 mt-8">
              <a href="/My-Resume-Web.pdf" download>
                <button className="h-10 bg-gray-800 hover:bg-gray-900 hover:scale-105 duration-200 text-white font-bold rounded-xl w-40">
                  Download CV
                </button>
              </a>
              <a
                href="https://www.fiverr.com/abir_ahmed340"
                target="_blank"
          ...
          <motion.div
            className="Right flex md:justify-end justify-center"
            whileInView={{ opacity: 1, y: -0 }}
            initial={{ opacity: 0, y: 100 }}
            transition={{ duration: 0.9 }}
          >
            <img
              className="md:w-[30vw] object-cover w-[40vw] rounded-full"
              src={myPic}
              alt=""
            />
          </motion.div>
