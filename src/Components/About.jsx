...
const About = () => {
    return (
        <div>
            ...
            >
                    <h1 className='font-bold text-3xl text-center text-white'>About Me</h1>
                ...
                <div className="container w-10/12 mx-auto py-8 grid grid-cols-1 md:grid-cols-2 items-center">
                    ...
                    <motion.div className="left flex justify-center"
                        whileInView={{opacity:1 , x:0}}
                        initial={{opacity:0 , x:-100}}
                        transition={{duration:0.5}}
>
                        <img src={picTure} className='lg:w-[30vw] md:w-[50vw] w-[70vw]' alt="" />
                    </motion.div>
                         <motion.div className="right text-center md:text-start mt-6"
                                            whileInView={{opacity:1 , y:0}}
                                            initial={{opacity:0 , y:-100}}
                                            transition={{duration:0.5}}
                         >
                                    <h1 className='font-semibold text-2xl text-white pb-8'>Abir Ahmed ( Web Developer )</h1>
                                    
                                    <p className='text-gray-500'> <span className='text-3xl font-bold text-white'>About Myself</span> <br /> <br />
